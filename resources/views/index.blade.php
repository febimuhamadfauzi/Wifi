...
<body class="index-page">
    ...
    <div class="topbar d-flex align-items-center">
      <div class="container d-flex justify-content-center justify-content-md-between">
        <div class="contact-info d-flex align-items-center">
          <i class="bi bi-envelope d-flex align-items-center"><a href="mailto:contact@example.com">hyperwave@gmail.com</a></i>
          <i class="bi bi-phone d-flex align-items-center ms-4"><span>0857653567834</span></i>
        </div>
    ...
    <div class="branding d-flex align-items-cente">
      ...
      <div class="container position-relative d-flex align-items-center justify-content-between">
        <a href="index.html" class="logo d-flex align-items-center">
          ...
          <h1 class="sitename">HyperWave</h1>
        </a>
        ...
        <div class="row gy-3">
          ...
          <div class="col-lg-6 d-flex flex-column justify-content-center" data-aos="fade-up" data-aos-delay="200">
            <div class="about-content ps-0 ps-lg-3">
              <h3>Masa Depan Internet Ada di Sini!</h3>
              <p class="fst-italic">
                Di HyperWave, kami menghadirkan koneksi internet super cepat, stabil, dan tanpa batas untuk memenuhi segala kebutuhan digital Anda. Dengan teknologi terbaru dan jaringan luas, kami berkomitmen memberikan pengalaman internet terbaik bagi rumah, bisnis, hingga industri.
              </p>
              <ul>
                <li>
                  <i class="bi bi-diagram-3"></i>
                  <div>
                    <h4>Kecepatan Ultra Cepat</h4>
                    <p>Streaming tanpa buffering, gaming tanpa lag, dan unduhan super kilat dengan jaringan kami yang andal.</p>
                  </div>
                </li>
                <li>
                  ...
                  <div>
                    ...
                    <p>Didukung oleh jaringan Fiber Optic & Wireless, memberikan fleksibilitas dan kecepatan optimal.</p>
                  </div>
                </li>
              </ul>
              <p>
                Saatnya beralih ke koneksi internet yang lebih cepat, stabil, dan inovatif! Hubungi kami sekarang dan rasakan perbedaannya.
              </p>
            </div>
          ...
          <div class="col-lg-5">
            ...
            <div class="info-wrap">
              ...
              <div class="info-item d-flex" data-aos="fade-up" data-aos-delay="400">
                ...
                <div>
                  <h3>Email Kami</h3>
                  <p>hyperwave@gmail.com</p>
                </div>
              </div><!-- End Info Item -->

              <iframe src="https://www.google.com/maps/embed?pb=!1m17!1m12!1m3!1d448.1745645517692!2d108.38024717492057!3d-7.23121746137808!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m2!1m1!2s!5e1!3m2!1sid!2sid!4v1740200087005!5m2!1sid!2sid" frameborder="0" style="border:0; width: 100%; height: 270px;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
            </div>
          </div>
  ...
  <footer id="footer" class="footer">
      ...
      <div class="row gy-4">
        <div class="col-lg-4 col-md-6 footer-about">
          <a href="index.html" class="d-flex align-items-center">
            <span class="sitename">HyperWave</span>
          </a>
          <div class="footer-contact pt-3">
            <p>Cipaku</p>
            <p>Ciamis, Jawa Barat</p>
            <p class="mt-3"><strong>Phone:</strong> <span>0857653567834</span></p>
            <p><strong>Email:</strong> <span>hyperwave@gmail.com</span></p>
          </div>
        </div>
        ...
        <div class="col-lg-2 col-md-3 footer-links">
          <h4>Layanan Kami</h4>
          <ul>
            <li><i class="bi bi-chevron-right"></i> <a href="#">Internet Rumah</a></li>
            <li><i class="bi bi-chevron-right"></i> <a href="#">Internet Bisnis</a></li>
            <li><i class="bi bi-chevron-right"></i> <a href="#">Dedicated Internet</a></li>
          </ul>
        </div>
    ...
    <div class="container copyright text-center mt-4">
      <p>© <span>Hak Cipta</span> <strong class="px-1 sitename">HyperWave</strong> <span>Semua Hak Dilindungi Undang-Undang</span></p>
      {{-- <div class="credits">
